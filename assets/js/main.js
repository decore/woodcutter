...
$(document).ready(function() {
	...
	//Parallax
	$(".request").parallax({ speed : 0.1 });
	$(".choose").parallax({ speed : 0.1 });


	//not active link
	$('.active a').click(function(e){e.preventDefault();});

	//main button toggle hover-effect class
	$('.plank-btn').mouseenter(function(){
		$(this).addClass('buz-out');
	});
	$('.plank-btn').mouseleave(function(){
		$(this).removeClass('buz-out');
	});
});
